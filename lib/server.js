...
server.init = function (options) {
  ...
  // Ensure host from upstream PR 779 is available while keeping existing options.
...
// Provide a restart method used elsewhere in the code to trigger a browser recycle.
